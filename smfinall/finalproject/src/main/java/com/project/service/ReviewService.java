...
public class ReviewService {
	...
	public void addUserReview(Review review, Long userId) {
	 ...
	 public int countRecipeReview(Long recipesId) {
	        return reviewMapper.countRecipeReview(recipesId);
	    }

	    public int countUserRecipeReview(Long userRecipesId) {
	        return reviewMapper.countUserRecipeReview(userRecipesId);
	    }
}