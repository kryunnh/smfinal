...
for (let i = 0; i < 6; i++) {
  ...
  return (
    <div className="recipe-form-container">
      <h2>{isEditing ? "레시피 수정" : "레시피 추가"}</h2>
  
      {/* ✅ 레시피명 입력 */}
      <label>레시피명</label>
      <input type="text" name="foodName" value={recipe.foodName} onChange={handleChange} />
      ...
      {/* ✅ 카테고리 선택 */}
      <label>카테고리 선택</label>
      <select name="categoryId" value={recipe.categoryId} onChange={handleChange}>
      ...
      {/* ✅ 날씨 선택 */}
      <label>날씨 선택</label>
      <select name="weatherId" value={recipe.weatherId} onChange={handleChange}>
