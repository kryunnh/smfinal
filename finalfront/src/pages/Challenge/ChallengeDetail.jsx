    ...
    return(
       ...
       <>
           ...
           <div className="recipe-header">
               <img src={`http://localhost:8080/uploads/api/userrecipes/${selectRecipes.foodImg}`} alt={selectRecipes.foodName} />
                       ...
                       return (
                           stepText && (
                               <div className="recipe-step" key={step}>
                                   ...
                                   {stepImg && (
                                   <img  src={`http://localhost:8080/uploads/api/userrecipes/${stepImg}`} 
       ...
       <div className="review">
           ...
           <h2>요리 후기</h2><p>({commentCounts[selectRecipes?.userRecipesId] || 0})</p>
           {review.length > 0 ? (
                   <ul>
                       {review.map((r) => (
                           <li key={r.reviewId}>
