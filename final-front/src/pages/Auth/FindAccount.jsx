...
export default function FindAccount() {
  ...
  return (
    <div className="find-account-container">
      <h1 className="find-account-title">FIND ID/PASSWORD</h1>
      ...
      <div className="tabs">
        ...
        <button
          className={`tab-button ${activeTab === "find-password" ? "active" : ""}`}
      ...
      {activeTab === "find-id" && (
        <div className="tab-content">
          ...
          <label>전화번호</label>
          <input type="text" className="input-field" value={phoneNumber} onChange={handlePhoneInput} maxLength="13" />
...
<input type="text" className="input-field" value={phoneNumber} onChange={handlePhoneInput} maxLength="13" />
          {isCodeSent && (
            <>
              <label>인증번호</label>
              <div className="input-group">
                <input type="text" className="input-field" value={verificationCode} onChange={(e) => setVerificationCode(e.target.value)} />
      ...
      {showResetModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <input type="password" className="input-field" placeholder="새 비밀번호" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} />
